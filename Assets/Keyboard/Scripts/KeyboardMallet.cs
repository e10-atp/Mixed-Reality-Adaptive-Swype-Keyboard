...
namespace Normal.UI
{
    ...
    public class KeyboardMallet : MonoBehaviour
    {
        ...
        [HideInInspector] public Vector3 malletHeadPosition;
        ...
        */
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            {
                Debug.LogError(
                    "Huh, I, this keyboard mallet, have struck something. However, I am not the child of a keyboard. A lost soul. It pains me to ignore this collision event. What does it mean? Who was it meant for? Unfortunately I am given no choice.");
                return;
            }
